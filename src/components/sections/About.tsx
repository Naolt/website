...
export function About() {
  return (
    <section id="about" className="py-24 bg-gradient-to-b from-black via-[#0a0a0a] to-black relative overflow-hidden">
        ...
        <div className="mt-16 space-y-16">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center">
                <p className="text-lg md:text-xl text-white/80 leading-relaxed">
                  ...
                  <span className="font-semibold text-white">5+ countries</span>, we help businesses compete globally.
                </p>
              </div>
            </div>
          </FadeIn>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <SlideIn direction="left" delay={0.1}>
              <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 hover:border-primary/50 hover:bg-white/10 transition-all group">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                <div className="group relative">
                  ...
                  <div className="relative bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 hover:border-primary/30 transition-all text-center h-full flex flex-col justify-center">
                    <div className="text-xl md:text-2xl font-bold text-primary mb-2 leading-tight">Development</div>
                    <div className="text-xs md:text-sm text-white/50">Web & Mobile</div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 hover:border-primary/30 transition-all text-center h-full flex flex-col justify-center">
                    ...
                    <div className="text-xs md:text-sm text-white/50">Business Systems</div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 hover:border-primary/30 transition-all text-center h-full flex flex-col justify-center">
                    ...
                    <div className="text-xs md:text-sm text-white/50">Visual Identity</div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 hover:border-primary/30 transition-all text-center h-full flex flex-col justify-center">
                    ...
                    <div className="text-xs md:text-sm text-white/50">Digital Growth</div>
                  </div>
                </div>
              </div>
            </div>
