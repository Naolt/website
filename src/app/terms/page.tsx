      ...
      <Container>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-lg max-w-none space-y-8">
            ...
            {/* Project Engagement */}
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">Project Engagement Process</h2>

              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Consultation and Proposal</h3>
              <p className="text-white/70 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Project Timeline</h3>
              <p className="text-white/70 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Revisions and Changes</h3>
              <p className="text-white/70 leading-relaxed">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Client Materials</h3>
              <p className="text-white/70 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Deliverables</h3>
              <p className="text-white/70 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Third-Party Components</h3>
              <p className="text-white/70 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Aurora Solutions Property</h3>
              <p className="text-white/70 leading-relaxed">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Service Warranty</h3>
              <p className="text-white/70 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Disclaimer</h3>
              <p className="text-white/70 leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">Support and Maintenance</h2>
              <p className="text-white/70 leading-relaxed">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Termination by Client</h3>
              <p className="text-white/70 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Termination by Aurora Solutions</h3>
              <p className="text-white/70 leading-relaxed mb-3">
            ...
            {/* Force Majeure */}
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">Force Majeure</h2>
              <p className="text-white/70 leading-relaxed">
            ...
            <section>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-6 space-y-2">
                <p className="text-white/90">
                  <strong>Email:</strong>{' '}
                  <a href="mailto:AuroraSolutions11@gmail.com" className="text-primary hover:underline">
