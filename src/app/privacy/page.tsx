        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Personal Information</h3>
              ...
              <h3 className="text-xl font-semibold text-white/90 mb-3 mt-6">Automatically Collected Information</h3>
              <p className="text-white/70 leading-relaxed mb-3">
